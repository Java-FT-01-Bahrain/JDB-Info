<div align="center">
  <a href="https://github.com/Java-PT-01-Bahrain/JDB-Info">
    <img src="./images/wiki.png" alt="wiki" height="500px" width="500px" >
  </a>
</div>
...
<!-- 
| <a href="https://github.com/SEB-Core/pr_template"><img src="./images/template.png" alt="template" width="30px"></a> | <a href="https://github.com/SEB-PT-7-Bahrain/js_challenges"><img src="./images/challenges.png" alt="challenges" width="30px"></a> | <a href="https://github.com/SEB-PT-7-Bahrain/public-apis"><img src="./images/api.png" alt="api" width="30px"></a> | <a href="https://github.com/SEB-PT-7-Bahrain/cs_concepts"><img src="./images/cs.png" alt="cs" width="30px"></a> |
| :---: | :---: | :---: | :---: | -->
...
<details><summary><strong>Team</strong></summary><p>
...
<div align="center">
  ...
  <p>I am nothing but a filler for where an instructor might put their personal brand statement! I just sit here and fill space so that the developer can see what it might look like when an instructor has actually provided them with their intro. Ihave no purpose beyond that and my existence is meaningless!</p>
...
<li><details><summary><strong>Outcomes</strong></summary><p>

<p>This team's job is to ensure your success <i>after</i> the course is complete. Any job search, resume, LinkedIn, or interview questions can be directed to them.</p>

<div align="center">
  <img src="https://ca.slack-edge.com/T03JBCX8WE7-U0858EYJ54L-e8ee0a3ae07b-512" alt="Esraa" width="200px" >
  <h3>Esraa Haji</h3>
  <h4>Career Coach</h4>
    <!-- <p>Hello everyone, I am a default placeholder for an instructors introduction paragraph. This instructor's role will be to be a faceless representation of what an instructor might be, but nothing more. They will lead no lessons, they will offer no help, they will father no sons. They are void.</p>
...
<p>There are <i>no observed Holidays</i> that fall during the dates of this course. If you have any questions regarding Holidays, or have a special circumstance, please don't hesitate to reach out to your Instructional Team.</p>
...
<details><summary><strong>Unit 1</strong> - JAVA Fundamentals </summary><p>
...
<ul type="none">
  ...
  <li><details><summary><strong>Week 6</strong></summary><p>
  ...
  <li><details><summary><strong>Week 8</strong></summary><p>
   <table>
    ...
    <tr>
      ...
      <td>
        Career Coaching 06.00 PM - 09.00 PM
        <br><hr>
      </td>
      <td>
      <a href="/Lessons/">OFF</a>
...
___
  ...
  <li><details><summary><strong>Week 9</strong></summary><p>
   <table>
    <tr>
      <th>Sunday</th>
      <th>Monday</th>
...
____
  ...
  <li><details><summary><strong>Week 11</strong></summary><p>
    ...
    <tr>
      ...
      <td>
        <a href="/Lessons/">Project Presentations</a>
        <br><hr>
      </td>
    </tr>
  </table>
...
<details><summary><strong>Unit 3</strong> - Data Structures, Algorithms, and Multithreading</summary><p>
...
<ul type="none">
  ...
  <table>
    ...
    Career Coaching 
      ...
      <td>
        <a href="/Lessons/Unit03/stacks/">Stacks</a>
        <br><hr>
        <a href="/Lessons/Unit03/queues/">Queues</a>
        <br><hr>
        <a href="/Lessons/Unit03/data-structure-lab/">Data Structures Lab (Deliverable) </a>
        <br><hr>
        Additional Material to Read:
        <br />
        <a href="/Lessons/Unit03/linked-lists/">Linked Lists</a>
        <br>
        <a href="/Lessons/Unit03/doubly-linked-lists/">Doubly Linked Lists</a>
        <!-- <br>
        <a href="/Lessons/Unit03/linked-lists-lab/">Linked Lists Lab</a> -->
        <br><hr>
      </td>
      <td>
        <a href="/Lessons/Unit03/binary-search/">Binary Search</a>
        <br><hr>
        <a href="/Lessons/Unit03/recursion/">Recursion</a>
        <br><hr>
        <a href="/Lessons/Unit03/tree-algorithms/">Tree Algorithms</a>
        <br><hr>
        <!-- <a href="/Lessons/Unit03/">Recursion Lab</a>
        <br><hr> -->
      </td>
      <td>
        <a href="/Lessons/Unit03/bubble-sort/">Bubble Sort</a>
        <br><hr>
        <a href="/Lessons/Unit03/selection-sort/">Selection Sort</a>
        <br><hr>
        <a href="/Lessons/Unit03/quicksort/">Quick Sort</a>
        <br><hr>
        <a href="/Lessons/Unit03/merge-sort/">Merge Sort</a>
        <br><hr>
        <a href="/Lessons/Unit03/algorithms-mini-project/">Algorithms Mini Project</a>
        <br><hr>
      </td>
    </tr>
  </table>
  ...
  <li><details><summary><strong>Week 13</strong></summary><p>
  ...
  <table>
    ...
    <tr>
     ...
     <td>
      ...
      <td>
        <a href="/Lessons/Unit03/algorithms-mini-project/">Algorithms Mini Project (Submission Date)</a>
        <br><hr>
      </td>
    </tr>
  </table>
  ...
  <li><details><summary><strong>Week 14</strong></summary><p>
  ...
  <table>
    ...
    <tr>
      <td>
        <a href="/Lessons/Unit03/introduction-to-concurrency/">Introduction to Concurrency</a>
        <br><hr>
        <a href="/Lessons/Unit03/understanding-race-conditions-and-synchronization/">Concurrency (Lab)</a>
        <br><hr> Additional Material to Read:
        <a href="/Lessons/Unit03/understanding-race-conditions-and-synchronization/">Race Conditions</a>
        <br><hr>
      </td>
      <td>
        <a href="/Lessons/Unit03/reentrantLock-readwritelock-and-semaphore/">Locks: ReentrantLock, ReadWriteLock, and Semaphore</a>
        <br><hr>
        <a href="/Lessons/Unit03/thread-status-and-pooling/">Thread Status and Pooling</a>
        <br><hr>
      </td>
      <td>Career Coaching
      </td>
      <td>
        <a href="/Lessons/Unit03/mini-project-concurrency/">Concurrency Mini Project</a>
        <br><hr>
      </td>
    </tr>
  </table>
...
___
  ...
  <li><details><summary><strong>Week 15</strong></summary><p>
...
___
  ...
  <li><details><summary><strong>Week 16</strong></summary><p>
  ...
  <table>
    ...
    <tr>
      <td>
        <a href="/Projects/Project-03/">Project 3 </a>
        <br><hr>
        <a href="/Projects/Project-03/">Work on Project</a>
        <br><hr>
      </td>
     <td>
        <a href="/Projects/Project-03/">Work on Project</a>
...
____
  ...
  <li><details><summary><strong>Week 17</strong></summary><p>
  ...
  <li><details><summary><strong>Week 18</strong></summary><p>
  ...
  <li><details><summary><strong>Week 19</strong></summary><p>
  ...
  <table>
    ...
    <tr>
     ...
     <td>
      ...
      <td>
        <a href="/Projects/Project-03/">Project 03 Presentation</a>
        <br><hr>
      </td>
      <td>
        <a href="/Projects/Project-03/">Project 03 Presentation</a>
...
<details><summary><strong>Unit 4</strong> - DevOps & Cloud Infrastructure</summary><p>
...
<ul type="none">
  ...
  <li><details><summary><strong>Week 20</strong></summary><p>
  ...
  <table>
    ...
    <tr>
      <td>
        <a href="/Lessons/Unit04/docker-intro-lesson/">Intro to Docker</a>
        <br><hr>
        <a href="/Lessons/Unit04/running-spring-boot-application-and-postgresql-database-using-docker-compose/">Building Docker Apps</a>
        <br><hr>
        <a href="/Lessons/Unit04/running-spring-boot-application-and-postgresql-database-using-docker-compose/">Docker Lab </a>
        <br><hr>
      </td>
      <td>
        <a href="/Lessons/Unit04/twelve-factor-design-lesson/">Twelve-Factor Application Design</a>
        <br><hr>
        <a href="/Lessons/Unit04/intro-cloud-infrastructure-lesson/">Intro to Cloud Infrastructure</a>
        <br><hr>
        <a href="/Lessons/Unit04/paas-intro-lesson/">Intro to Platform-as-a-Service (PaaS)</a>
        <br><hr>
      </td>
      <td>
        <a href="/Lessons/Unit04/intro-aws-lesson/">Intro AWS</a>
        <br><hr>
        <a href="/Lessons/Unit04/deploying-a-springboot-restapi-application-on-aws-elastic-beanstalk/">Deploy Application on Elastic Beanstalk</a>
        <br><hr>
      </td>
        <td>
        <a href="/Lessons/Unit04/deploying-a-springboot-restapi-application-on-aws-elastic-beanstalk/">Deploy Application on Elastic Beanstalk</a>
  ...
  <li><details><summary><strong>Week 21</strong></summary><p>
  ...
  <table>
    ...
    <tr>
     ...
     <td>
        <a href="/Lessons/Unit04/jenkins-lab/">Continuous Integration and Delivery - Jenkins</a>
        <br><hr>
        <a href="/Projects/Project-04/">Project 4 </a>
        <br><hr>
      </td>
      <td>
        Career Coaching 06.00 pm - 09.00 pm
      ...
      <a href="/Projects/Project-04/">Project 4 </a>
        <br><hr>
        <a href="/Projects/Project-04/">Work on Project</a>
        <br><hr>
      </td>
    </tr>
  </table>
  ...
  <li><details><summary><strong>Week 22</strong></summary><p>
...
___
  ...
  <li><details><summary><strong>Week 23</strong></summary><p>
...
___
  ...
  <li><details><summary><strong>Week 24</strong></summary><p>
  ...
  <table>
    ...
    <tr>
      <td>
        <a href="/Projects/Project-04/">Project Presentations</a>
        <br><hr>
      </td>
    </tr>
  </table>
...
Below is a list of additional resources that were hand-picked by your instructors. If you find that you don't have the time during the course, these resources will still help to solidify your understanding of key concepts after graduation.
  ...
  <li><details><summary><strong>Tools</strong> - <i>things to make you more efficient</i></summary><p>
  ...
  <li><details><summary><strong>Practice</strong> - <i>sites to hone your skills</i></summary><p>
  ...
  <li><details><summary><strong>Bookmarks</strong> - <i>must-have resources</i></summary><p>
  ...
  <li><details><summary><strong>Reading</strong> - <i>helpful articles and topics</i></summary><p>
  ...
  <li><details><summary><strong>Documentation</strong> - <i>commonly used tech docs</i></summary><p>
  ...
  <li><details><summary><strong>Cheatsheets</strong> - <i>quick references</i></summary><p>
  ...
  <li><details><summary><strong>Deployment</strong> - <i>get your projects online</i></summary><p>
  ...
  <li><details><summary><strong>CSS Libraries</strong> - <i>use different libraries to ramp up your apps</i></summary><p>
  ...
  <li><details><summary><strong>Animations, Images, Sounds, Fonts & Icons</strong> - <i>add fun CSS to your projects</i></summary><p>
  ...
  <li><details><summary><strong>Color Palettes</strong> - <i>color match or check out color schemes</i></summary><p>
  ...
  ____
   ...
   <li><details><summary><strong>AI</strong> - <i>use these tools to make yourself a better human</i></summary><p>
  ...
  <li><details><summary><strong>YouTube Channels</strong> - <i>watch and learn</i></summary><p>
